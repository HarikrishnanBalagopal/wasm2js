...
export const setupDinoDemo = async (compiledModule: MyWasmModule) => {
    console.log('setting up the dino demo');
    ...
    const canvasData = new Uint8Array((instance.exports.mem as unknown as Uint8Array).buffer, 0x5000, 90000);
    const context = canvas.getContext('2d');
    const imageData = context.createImageData(W, H);
    const u8 = new Uint8Array((instance.exports.mem as unknown as Uint8Array).buffer, 0, 4);
